...
To install under a team-specific profile name, pass `--profile-name <name>`. The generated `config.yaml` and packaged runners will use that same profile name by default.
